...
> **Status**: Completed. Kept here as reference/portfolio material. For the next steps in this learning path, see [AZ-500 (Security Engineer)](../AZ-500/README.md) and [SC-300 (Identity and Access Administrator)](../SC-300/README.md).
